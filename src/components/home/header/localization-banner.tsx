    ...
    <div className={'hidden md:flex border-border/50 border-b-2 bg-background'}>
      <div className={'flex flex-1 justify-center items-center p-2 gap-8'}>
        <div className={'flex items-center gap-4'}>
          <Image src={'/assets/icons/localization-icon.svg'} alt={'أيقونة التسعير المحلي'} width={36} height={36} />
          <p className={'text-[16px] font-medium text-center'}>استعرض الأسعار حسب الدولة</p>
          <Link
